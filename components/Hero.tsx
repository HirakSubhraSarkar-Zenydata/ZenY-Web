...
//       title: "The Architecture of Decision Science",
//       subtitle:
//         "Custom ML frameworks engineered to power autonomous operations and boardroom-level clarity.",
//     },
//     {
//       title: "Cognitive Enterprise Data Fabrics",
//       subtitle:
//         "Secure, governed, infinitely scalable cloud infrastructures for the post-digital enterprise.",
//     },
//   ];
...
//         .hero-glow {
//           box-shadow: 0 0 70px rgba(46, 28, 255, 0.28);
//         }
...
//           <div className="absolute inset-0 bg-[#020617]/35 z-10" />
...
//           <div
//             key={`badge-${activeIndex}`}
//             className="fade-enter inline-flex items-center gap-3 text-blue-400 text-[9px] font-semibold uppercase tracking-[0.4em] mb-4"
//           >
//             <span className="w-8 h-[2px] bg-blue-600 hero-glow" />
//             {currentSlide.badge}
//           </div>
...
//             key={`title-${activeIndex}`}
//             className="
//               fade-enter hero-title text-white font-bold
//               text-[24px]
//               sm:text-[32px]
//               lg:text-[40px]
//               xl:text-[44px]
...
//             key={`subtitle-${activeIndex}`}
//             className="
//               fade-enter hero-subtitle text-slate-300
//               text-[14px]
//               sm:text-[15px]
//               lg:text-[16px]
...
//             "
//           >
//             {dataFocusContent[activeIndex].subtitle}
//           </p>
...
//       {/* ===== SLIDE INDICATORS ===== */}
//       <div className="absolute bottom-6 right-6 sm:bottom-10 sm:right-12 flex flex-col gap-4 z-40">
//         {HERO_SLIDES.map((_, i) => (
//           <button
//             key={i}
//             onClick={() => setActiveIndex(i)}
...
//           >
//             <span
//               className={`text-[9px] font-semibold tracking-[0.3em] transition-all ${
//                 i === activeIndex
//                   ? "text-white"
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        /* Executive fade */
        .fade-enter {
          animation: executiveFade 0.9s cubic-bezier(.22,1,.36,1) both;
        }

        @keyframes executiveFade {
          from {
            opacity: 0;
        ...
        >
          ...
          {currentSlide.type === "video" ? (
            <video
              ...
              playsInline
              preload="metadata"
              className="w-full h-full object-cover parallax-video"
            >
              <source src={currentSlide.url} type="video/mp4" />
            </video>
          ) : (
