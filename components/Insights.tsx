...
//           <div>
//             <h2 className="text-indigo-600 font-bold uppercase tracking-[0.2em] text-sm mb-4">
//               Latest Thinking
//             </h2>
...
//             className="hidden md:flex items-center gap-2 text-slate-900 font-bold text-sm uppercase border-b-2 border-indigo-600 pb-1 hover:text-indigo-600 transition-all"
//           >
//             View All Insights
//           </button>
//         </div>
