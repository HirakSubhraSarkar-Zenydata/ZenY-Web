  ...
  return (
    <section className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            <h2 className="text-[#2E1CFF] font-bold uppercase tracking-[0.4em] text-sm mb-4">
              Strategic Core
            </h2>
            <h3 className="text-4xl lg:text-5xl font-extrabold text-slate-900 leading-tight">
              High-Performance Architectures
          ...
          <div className="flex flex-col items-start gap-6">
            <p className="text-slate-500 max-w-md text-lg leading-relaxed">
              Our core disciplines focused on shifting the needle for the world's
              most data-intensive organizations.
            </p>
            ...
            >
              <div className="mb-8 p-5 bg-slate-50 inline-block rounded-2xl group-hover:bg-blue-50 transition-colors">
                <img
                  src={service.icon}
                  alt={service.title}
                  className="w-10 h-10 grayscale group-hover:grayscale-0 transition-all brightness-75 group-hover:brightness-100"
                />
              </div>

              <h4 className="text-2xl font-bold text-slate-900 mb-4 group-hover:text-[#2E1CFF] transition-colors">
                {service.title}
              </h4>
