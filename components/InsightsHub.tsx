    ...
    <div className="min-h-screen pt-40 pb-24 bg-white">
      <section className="max-w-7xl mx-auto px-6 mb-24">
        <div className="max-w-4xl space-y-8">
          ...
          <h1 className="text-6xl lg:text-8xl font-black text-slate-950 leading-[0.95] tracking-tighter">
            The Digital <br />
            <span className="text-slate-400">Thesis Library</span>.
          </h1>

          <p className="text-xl lg:text-2xl text-slate-500 font-medium leading-relaxed max-w-2xl">
            Our specialized intelligence units publish deep-dives into
            architectural innovation and the future of enterprise engineering.
          </p>
        </div>
      </section>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="text-[#2E1CFF] font-black uppercase tracking-[0.3em] text-[10px] flex items-center gap-2 group-hover:gap-4 transition-all pt-4"
              >
                Full Thesis
                <span>→</span>
              </button>
