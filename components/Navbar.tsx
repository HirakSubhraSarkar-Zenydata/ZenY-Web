      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-12 gap-10">
          <div className="col-span-9 grid grid-cols-3 gap-y-8 gap-x-12">
            {SERVICES.map((item) => (
              <button
                ...
                className="group flex gap-5 text-left transition-all"
              >
                <div className="shrink-0 w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center text-[#2E1CFF] group-hover:bg-[#2E1CFF] group-hover:text-white group-hover:scale-110 transition-all duration-300">
                  <img
                    src={item.icon}
                    alt=""
                    className="w-6 h-6 grayscale group-hover:grayscale-0 group-hover:brightness-0 group-hover:invert transition-all"
                  />
                </div>
                <div>
                  <h4 className="text-[12px] font-bold text-slate-900 mb-1.5 uppercase tracking-widest group-hover:text-[#2E1CFF]">
          ...
          <div
            ...
            className="col-span-3 bg-[#020617] rounded-3xl p-8 flex flex-col justify-between relative group cursor-pointer"
          >
            <div className="absolute top-0 right-0 w-48 h-48 bg-[#2E1CFF] blur-[100px] opacity-20 group-hover:opacity-40 transition-opacity" />
            <div className="relative z-10">
              <span className="text-[#2E1CFF] text-[9px] font-bold uppercase tracking-[0.4em]">
                Strategic Hub
              </span>
              <h5 className="text-white text-lg font-bold mt-4 mb-3">
                All Engineering Capabilities
              </h5>
              <p className="text-slate-400 text-[10px]">
                Browse our full methodology and framework library.
              </p>
            </div>
            <span className="text-white text-[10px] font-bold uppercase tracking-[0.2em] mt-8 flex items-center gap-2 group-hover:gap-4 transition-all relative z-10">
              Explore All <span className="text-[#2E1CFF]">→</span>
            </span>
          </div>
        </div>
      </div>
