          ...
          <div className="lg:col-span-4 space-y-10">
            ...
            <div className="flex gap-4">
              {[
                {
                  name: "LinkedIn",
                  icon: "M4.98 3.5C4.98 5 3.86 6.1 2.5 6.1S0 5 0 3.5 1.12.9 2.48.9 4.98 2 4.98 3.5zM0 8.2h5v15.8H0V8.2zM8.5 8.2h4.8v2.2h.1c.7-1.3 2.4-2.7 4.9-2.7 5.3 0 6.3 3.5 6.3 8v8.3h-5v-7.4c0-1.8 0-4.2-2.6-4.2-2.6 0-3 2-3 4v7.6h-5V8.2z",
                  url: "https://in.linkedin.com/company/zenydata-technologies",
                },

                {
                  name: "Google",
                  icon: "M21.35 11.1h-9.2v2.9h5.3c-.23 1.5-1.76 4.4-5.3 4.4-3.2 0-5.8-2.7-5.8-6s2.6-6 5.8-6c1.8 0 3 .8 3.7 1.5l2.5-2.4C17 3.7 15 2.7 12.15 2.7 6.8 2.7 2.5 7 2.5 12.3s4.3 9.6 9.65 9.6c5.6 0 9.3-3.9 9.3-9.4 0-.6-.05-1.1-.1-1.4z",
                  url: "https://www.google.com/search?q=ZenYData+Technologies",
                },

                {
                  name: "Email",
                  icon: "M2 4h20v16H2z M2 4l10 9 10-9",
                  url: "mailto:sales@zenydata.com",
                },
              ].map((social) => (
                <a
                  target="_blank"
