...
const Logo: React.FC<LogoProps> = ({ className = "", light = false }) => {
  ...
  return (
    <div
      onClick={() => navigate("/")}
      className={`flex items-center gap-4 select-none cursor-pointer ${className}`}
    ...
    >
      ...
      <div className="w-11 h-11 shrink-0">
        ...
        >
          <path d="M12 35L42 35L30 62L12 35Z" fill="#7C69FF" />
          <path d="M42 35L72 68L42 92L42 35Z" fill="#2E1CFF" />
          <path d="M30 62L42 92L30 84L30 62Z" fill="#7C69FF" opacity="0.8" />
          <path d="M72 35L80 48L72 68L72 35Z" fill="#2E1CFF" />
          <path d="M80 48L90 42L80 54L80 48Z" fill="#1A1199" />
          <path d="M56 50L72 35L72 68L56 50Z" fill="#B2A9FF" />
      ...
      <div className="flex flex-col justify-center">
        <span
          className={`logo-font text-xl font-black tracking-tight leading-none ${
        ...
        <span
          className={`text-[9px] font-extrabold uppercase tracking-[0.45em] mt-1.5 ${
